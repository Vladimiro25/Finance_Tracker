...
import com.uzunguc.financetracker.core.common.delegate.DefaultMviDelegate
...
class HomeViewModel : ViewModel(), MviController<HomeUiState, HomeUiEvent> {
    ...
    private val mviDelegate = DefaultMviDelegate<HomeUiState, HomeUiEvent>(initialState = HomeUiState.Loading)
